...
<head>
    ...
    <meta name="google-site-verification" content="jXBUGS0ZHICisH2OvDZS_tuK4w49BGHbp6kTl4tkHnM" />
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #A50044, #004D98); /* FC Barcelona colors */
            color: #fff;
            margin: 0;
            padding: 0;
            display: flex;
